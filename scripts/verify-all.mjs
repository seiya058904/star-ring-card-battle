...
const suites = [
  ...
  { name: "战役/沙盒结果页按钮", file: "scripts/verify-campaign-result-actions.mjs" },
  { name: "战斗速度时间轴", file: "scripts/verify-battle-speed-timeline.mjs" },
  { name: "Release 版本校验分流", file: "scripts/verify-release-workflow.mjs" },
